...
class Ui_MenuSuperviseur(object):
    def setupUi(self, MenuSuperviseur):
        ...
        self.labelErreurSelection.setGeometry(QtCore.QRect(20, 508, 591, 31))
        ...
        self.listViewEmploye = QtWidgets.QListView(MenuSuperviseur)
        self.listViewEmploye.setGeometry(QtCore.QRect(10, 178, 621, 341))
        ...
        self.pushButtonRetournerEmploye.setGeometry(QtCore.QRect(650, 528, 151, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(13)
    ...
    def retranslateUi(self, MenuSuperviseur):
        ...
        self.pushButtonRetournerEmploye.setText(_translate("MenuSuperviseur", "Gestion employé"))
