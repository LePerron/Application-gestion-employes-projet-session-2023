...
class Ui_MainsWindowIntra(object):
    def setupUi(self, MainsWindowIntra):
        ...
        self.pushButtonMenuEmployer = QtWidgets.QPushButton(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonMenuEmployer.sizePolicy().hasHeightForWidth())
        self.pushButtonMenuEmployer.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.pushButtonMenuEmployer.setFont(font)
        self.pushButtonMenuEmployer.setCheckable(False)
        self.pushButtonMenuEmployer.setAutoRepeat(False)
        self.pushButtonMenuEmployer.setAutoExclusive(False)
        self.pushButtonMenuEmployer.setObjectName("pushButtonMenuEmployer")
        self.LayoutMenu.addWidget(self.pushButtonMenuEmployer)
    ...
    def retranslateUi(self, MainsWindowIntra):
        ...
        self.pushButtonMenuEmployer.setText(_translate("MainsWindowIntra", "Gérer les Employés"))
        self.pushButtonMenuContrat.setText(_translate("MainsWindowIntra", "Gérer les Contrats"))
        self.pushButtonMenuPaye.setText(_translate("MainsWindowIntra", "Gérer les Payes"))
        self.pushButtonMenuSpecialite.setText(_translate("MainsWindowIntra", "Gérer les Spécialitées"))
