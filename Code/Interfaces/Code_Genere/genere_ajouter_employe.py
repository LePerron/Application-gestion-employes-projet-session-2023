...
class Ui_DialogAjouterEmploye(object):
    def setupUi(self, DialogAjouterEmploye):
        ...
        DialogAjouterEmploye.resize(393, 779)
        ...
        self.frame.setGeometry(QtCore.QRect(0, 70, 391, 701))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.layoutWidget = QtWidgets.QWidget(self.frame)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 351, 661))
        ...
        self.labelSuperviseur = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.labelSuperviseur.setFont(font)
        self.labelSuperviseur.setObjectName("labelSuperviseur")
        self.verticalLayout_8.addWidget(self.labelSuperviseur)
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.comboBoxSuperviseur = QtWidgets.QComboBox(self.layoutWidget)
        self.comboBoxSuperviseur.setObjectName("comboBoxSuperviseur")
        self.comboBoxSuperviseur.addItem("")
        self.verticalLayout_9.addWidget(self.comboBoxSuperviseur)
        self.labelErreurSuperviseur = QtWidgets.QLabel(self.layoutWidget)
        self.labelErreurSuperviseur.setText("")
        self.labelErreurSuperviseur.setObjectName("labelErreurSuperviseur")
        self.verticalLayout_9.addWidget(self.labelErreurSuperviseur)
        spacerItem2 = QtWidgets.QSpacerItem(68, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Ignored)
    ...
    def retranslateUi(self, DialogAjouterEmploye):
        ...
        self.labelSuperviseur.setText(_translate("DialogAjouterEmploye", "Superviseur"))
        self.comboBoxSuperviseur.setItemText(0, _translate("DialogAjouterEmploye", "Aucun pour l\'instant"))
