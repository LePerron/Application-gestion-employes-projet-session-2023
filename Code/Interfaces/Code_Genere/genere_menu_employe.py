...
class Ui_DialogMenuEmploye(object):
    def setupUi(self, DialogMenuEmploye):
        ...
        DialogMenuEmploye.resize(820, 610)
        font = QtGui.QFont()
        ...
        self.pushButtonRetournerMenu.setGeometry(QtCore.QRect(650, 549, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.labelErreurSelection.setGeometry(QtCore.QRect(20, 519, 591, 31))
        ...
        self.line_2.setGeometry(QtCore.QRect(630, 520, 3, 80))
