...
class Ui_DialogMenuEmploye(object):
    def setupUi(self, DialogMenuEmploye):
        ...
        self.pushButtonRetournerSuperviseur = QtWidgets.QPushButton(DialogMenuEmploye)
        self.pushButtonRetournerSuperviseur.setGeometry(QtCore.QRect(650, 530, 151, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(13)
        sizePolicy.setHeightForWidth(self.pushButtonRetournerSuperviseur.sizePolicy().hasHeightForWidth())
        self.pushButtonRetournerSuperviseur.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButtonRetournerSuperviseur.setFont(font)
        self.pushButtonRetournerSuperviseur.setObjectName("pushButtonRetournerSuperviseur")
        ...
        self.pushButtonRetournerMenu_2 = QtWidgets.QPushButton(DialogMenuEmploye)
        self.pushButtonRetournerMenu_2.setGeometry(QtCore.QRect(650, 580, 151, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(13)
    ...
    def retranslateUi(self, DialogMenuEmploye):
        ...
        self.pushButtonRetournerSuperviseur.setText(_translate("DialogMenuEmploye", "Gestion superviseur"))
        ...
        self.pushButtonRetournerMenu_2.setText(_translate("DialogMenuEmploye", "Menu"))
