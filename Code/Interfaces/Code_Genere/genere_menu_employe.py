...
class Ui_DialogMenuEmploye(object):
    def setupUi(self, DialogMenuEmploye):
        ...
        DialogMenuEmploye.resize(804, 525)
        font = QtGui.QFont()
        font.setPointSize(13)
        DialogMenuEmploye.setFont(font)
        self.labelEmploye = QtWidgets.QLabel(DialogMenuEmploye)
        self.labelEmploye.setGeometry(QtCore.QRect(30, 30, 411, 51))
        font = QtGui.QFont()
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(420, 240, 321, 64))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(420, 80, 319, 61))
        ...
        self.listViewEmploye.setGeometry(QtCore.QRect(30, 81, 381, 341))
        self.listViewEmploye.setObjectName("listViewEmploye")
        self.labelErreurSelection = QtWidgets.QLabel(DialogMenuEmploye)
        self.labelErreurSelection.setGeometry(QtCore.QRect(30, 450, 711, 41))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(420, 150, 321, 83))
        ...
        self.pushButtonAjouterEmploye.setGeometry(QtCore.QRect(420, 320, 151, 41))
        ...
        self.pushButtonModifierEmploye.setGeometry(QtCore.QRect(420, 380, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.pushButtonSupprimerEmploye.setGeometry(QtCore.QRect(590, 320, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.pushButtonRetournerMenu.setGeometry(QtCore.QRect(590, 380, 151, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
    ...
    def retranslateUi(self, DialogMenuEmploye):
        ...
        self.labelEmploye.setText(_translate("DialogMenuEmploye", "Gestionnaire des employés"))
