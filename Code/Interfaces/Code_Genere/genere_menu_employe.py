...
class Ui_DialogMenuEmploye(object):
    def setupUi(self, DialogMenuEmploye):
        ...
        self.listViewEmploye.setGeometry(QtCore.QRect(30, 81, 256, 261))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(300, 182, 321, 83))
        ...
        self.pushButtonModifierEmploye = QtWidgets.QPushButton(self.horizontalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.pushButtonModifierEmploye)
