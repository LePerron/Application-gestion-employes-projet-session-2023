...
class Ui_DialogMenuEmploye(object):
    def setupUi(self, DialogMenuEmploye):
        ...
        self.pushButtonMenuSuperviseur = QtWidgets.QPushButton(DialogMenuEmploye)
        self.pushButtonMenuSuperviseur.setGeometry(QtCore.QRect(650, 530, 151, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(13)
        sizePolicy.setHeightForWidth(self.pushButtonMenuSuperviseur.sizePolicy().hasHeightForWidth())
        self.pushButtonMenuSuperviseur.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButtonMenuSuperviseur.setFont(font)
        self.pushButtonMenuSuperviseur.setObjectName("pushButtonMenuSuperviseur")
    ...
    def retranslateUi(self, DialogMenuEmploye):
        ...
        self.pushButtonMenuSuperviseur.setText(_translate("DialogMenuEmploye", "Gestion superviseur"))
