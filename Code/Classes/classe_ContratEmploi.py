...
class ContratEmploi:
    ...
    def __init__(self, p_identifiant_contrat: int = 0, p_employe: Employe = None, p_facteur_salaire: float = 0.0,
                 p_nb_heures_semaine: int = 0, p_salaire_de_horraire: float = 0.0, p_termes_embauche: str = "",
        ...
        :param p_salaire_de_horraire: Le salaire de base de l'employé
        ...
        self._salaire_de_horraire = p_salaire_de_horraire
    ...
    @property
    def salaire_de_horraire(self):
        return self._salaire_de_horraire

    @salaire_de_horraire.setter
    def salaire_de_horraire(self, v_salaire_de_horraire):
        if isinstance(v_salaire_de_horraire, float) and v_salaire_de_horraire > 0:
            self._salaire_de_horraire = v_salaire_de_horraire
    ...
    def __str__(self):
        ...
        """
        return (f"IDENTIFIANT DU CONTRAT : {self.identifiant_contrat} - SALAIRE DE BASE : {self.salaire_de_horraire} $ - "
