...
specialite3 = Specialite("Legumes", "celui qui gère les Légumes")
...
def test_supprimer_specialite(specialite_a_supprimer: str, resultat_attendu: list):
    """
    Un test unitaire qui test si la méthode **supprimer_specialite** supprime une spécialité correctement.
    :param specialite_a_supprimer: Le nom de la spécialité à enlever.
    :param resultat_attendu: Le résultat attendu.
    """
    liste_avant = Specialite.list_des_specialites[::]
    ...
    Specialite.list_des_specialites = liste_avant
